...
def bisection_search(func, left, right, tol=1e-3, max_it=100):
    ...
    if abs(func(left)) <= tol:
        print(
            "Warning: An estimated root is found before the bisection method. "
    ...
    assert left < right, (
        "An error is encountered in the bisection method: initial interval is not legit,"
    ...
    while abs(func(mid)) > tol:
        # ===========================================
        # (2) compute the function value at the left endpoint of the interval
        func_val_left = func(left)
        # (3) compute the function value at the midpoint of the interval
        ...
        it_counter += 1
        # ======================================================================================
        # (5) compute the midpoint of the new interval
        mid = (left + right) / 2
        # ======================================================================================
    ...
    print(
        "The root is found after {} iterations! \nEstimated root: {}, "
...
def newton_root_search(func, init_guess, tol=1e-3, max_it=100):
    ...
    while abs(value) > tol:
        ...
        est_root -= value / gradient
        # ======================================================================================
        # increment the iteration counter
        it_counter += 1
        # ======================================================================================
        # (8) compute the function value and gradient the new estimated root
        value, gradient = func(est_root)
        # ======================================================================================
        # display the results
        print("Iteration {}, x = {}, f(x) = {}, f'(x) = {}\n".format(it_counter, est_root, value, gradient))
